...
extension MainCardCell: ReactorKit.View, HasDisposeBag {
    ...
    private func configCell(_ item: MainCardModel) {
...
extension MainCardCell {
    class func size(_ width: CGFloat, _ reactor: MainCardCellReactor) -> CGSize {
